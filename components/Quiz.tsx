...
export const Quiz: React.FC<QuizProps> = ({ questions, category, onFinish, onBack }) => {
  ...
  const getOptionStyle = (optionValue: string) => {
    ...
    // Removed mb-3 to reduce spacing
    let baseStyle = "w-full p-4 rounded-xl border text-left transition-all duration-200 relative ";
    ...
    <div className="flex flex-col h-full overflow-hidden relative">
      ...
      >
        <div className="mb-6">
          ...
          <h2 className="text-xl font-bold text-gray-900 leading-relaxed drop-shadow-sm">
